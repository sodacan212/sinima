<?php
    ...
    $judul_halaman = 'penilaian mata kuliah';
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card-box">
                                    ...
                                    <form method="POST" action="<?php echo BASE_URL ?>kontrol/mata-kuliah?aksi=penilaian&id=<?php echo $_GET['id'] ?>">
                                                ...
                                                <tbody>
                                                    <?php for ($i=0; $i <count($mahasiswa) ; $i++) { ?>
                                                        <tr>
                                                            ...
                                                            <td><input type="hidden" name="id[]" value="<?php echo $mahasiswa[$i]['id'] ?>"><?php echo $mahasiswa[$i]['nim'] ?></td>
                                                            <td><input type="hidden" name="mahasiswa_id[]" value="<?php echo $mahasiswa[$i]['mahasiswa_id'] ?>"><?php echo $mahasiswa[$i]['nama_mahasiswa'] ?></td>
                                                            <td><input type="number" class="form-control" min="0" max="100" name="nilai_tugas[]" value="<?php echo $mahasiswa[$i]['nilai_tugas'] ?>"></td>
                                                            <td><input type="number" class="form-control" min="0" max="100" name="nilai_keaktifan[]" value="<?php echo $mahasiswa[$i]['nilai_keaktifan'] ?>"></td>
                                                            <td><input type="number" class="form-control" min="0" max="100" name="nilai_kehadiran[]" value="<?php echo $mahasiswa[$i]['nilai_kehadiran'] ?>"></td>
                                                            <td><input type="number" class="form-control" min="0" max="100" name="nilai_uts[]" value="<?php echo $mahasiswa[$i]['nilai_uts'] ?>"></td>
                                                            <td><input type="number" class="form-control" min="0" max="100" name="nilai_uas[]" value="<?php echo $mahasiswa[$i]['nilai_uas'] ?>"></td>
                                                        </tr>
